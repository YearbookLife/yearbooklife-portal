...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const customerData = {
      ...
      finalReviewCompleted: properties.final_review_completed || '',
      bookProgress: properties.book_progress || '',
